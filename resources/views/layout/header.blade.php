<header>
    {{-- <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-bs-target="#navbarColor01"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item"
                                        href="{{ route('userProfile.show', Auth::user()->id) }}">User Profile</a>
                                    <a class="dropdown-item" href="{{ route('changePassword.show') }}">Change
                                        Password</a>
                                </div>
                            </div>
                        </li>
